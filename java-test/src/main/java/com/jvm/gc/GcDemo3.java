...
/**
 * -XX:NewSize=10M -XX:MaxNewSize=10M -XX:InitialHeapSize=20M -XX:MaxHeapSize=20M -XX:SurvivorRatio=8 -XX:MaxTenuringThreshold=15 -XX:PretenureSizeThreshold=10M -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:java-test/src/main/java/com/jvm/gc/gc-demo3.log
 * <p>
...
public class GcDemo3 {
    ...
    public static void main(String[] args) {
        ...
        //2MB+2MB+128KB小于老年代剩余空间，不用进行老年代垃圾回收，直接新生代回收
        //开始进行GC，回收掉2MB 2MB 128KB，还有2MB存活
        //2MB放不下Survivor(1MB)中，小于老年代空间，不用进行老年代垃圾回收，直接放到老年代
