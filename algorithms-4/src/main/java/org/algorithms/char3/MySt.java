...
public class MySt<Key extends Comparable<Key>, Value> implements Iterable<Key> {
	...
	private TreeMap<Key, Value> mySt;

	/**
	 * Initializes an empty symbol table.
	 */
	public MySt() {
		mySt = new TreeMap<Key, Value>();
	}
	 ...
	 *         symbol table; {@code null} if the key is not in this symbol table
	 ...
	 * <p>
	 * To iterate over all of the keys in the symbol table named {@code st}, use
	 * the foreach notation: {@code for (Key key : st.keys())}.
	 *
	...
	/**
	 * Returns all of the keys in this symbol table. To iterate over all of the
	 * keys in a symbol table named {@code st}, use the foreach notation:
	 * {@code for (Key key : st)}.
	 * <p>
